...
print("my key is ",GOOGLE_API_KEY)
...
st.set_page_config(
    page_title="!!!Chat Bot and Image Captioning by KOYEL!!!",
    page_icon=":robot:",
    layout="centered",
...
if user_picked=="Chatbot":
    ...
    st.title("Koyel's Chat Bot:robot_face:")
    st.write("Hi, I am your chat bot created by Koyel. How can I help you today?")
...
if user_picked=="Image Captioning":
    model=gemini_vision()
    st.title("Koyel's Image Captioning App:camera:")
